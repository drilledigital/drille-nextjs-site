...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    challenge:
      "The original store had been built quickly and hadn't kept pace with the business's growth. Product discovery was poor — users couldn't find what they were looking for without already knowing it was there. The checkout experience had too much friction, with an abandonment rate that pointed to process problems rather than demand problems. On the SEO side, the site had essentially no organic presence — it was invisible to the search queries that should have been driving its best customers. The brand also lacked a consistent visual language online, which was eroding the trust that the physical stores had carefully built.",
    solution:
      "We rebuilt the store from the ground up on a modern e-commerce stack, with information architecture designed around how customers actually browse — by lifestyle context, not just product category. The checkout flow was stripped to its essentials, reducing the number of steps required to complete a purchase. A new visual system aligned the digital experience with the warmth and quality of the in-store experience. The SEO programme ran in parallel — we conducted keyword research, rebuilt the site's content architecture around high-intent queries, and developed an on-page content strategy that compounded month over month.",
    results:
  ...
  },
  {
    ...
    challenge:
      "Think tanks and policy institutes face a particular design challenge: they need to communicate rigor and depth without sacrificing accessibility. The IID's existing site was dense with content but structured in a way that made the most important work hard to find. The visual language felt dated — more government portal than forward-thinking institution. For an organisation that was trying to influence decision-making at the highest levels of African governance, the first impression mattered enormously, and the existing site wasn't making it. The new site also needed to serve a genuinely international audience, including multilateral development bank staff, government ministers, and academic researchers — each with very different reading habits.",
    solution:
      "The identity we developed leaned into the tension between structure and motion — the IID's work is about systems in flux, and the visual language needed to carry that. A refined typographic system gave the brand the authority it needed while a structured grid layout brought order to the content complexity. The website was built around a publication architecture that made research easy to discover, filter, and share — acting almost like a specialised journal interface rather than a standard institutional site. The homepage was designed to surface the IID's most current and significant work immediately, with longer exploration pathways for visitors who wanted to go deeper.",
    results:
