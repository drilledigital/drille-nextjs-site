...
const images = [
  "/assets/images/automation system reference.jpg",
  "/assets/images/Brand Identity Reference.jpg",
  "/assets/images/Digital Marketing Reference.jpg",
  "/assets/images/Website Reference.jpg",
  "/assets/images/Marketing tech mockup.jpg",
  "/assets/images/Brand Identity Mockups Anza.jpg",
  "/assets/images/Risk into opportunity mockup.jpg",
];
    ...
    <ReactLenis root>
      <section className="relative flex w-screen flex-col items-center gap-[10vh] px-4 pt-[50vh]">
        <div className="absolute left-1/2 top-24 grid -translate-x-1/2 content-start justify-items-center gap-6 text-center">
          <span className="after:from-background after:to-foreground relative max-w-[12ch] text-4xl uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full after:h-16 after:w-px after:bg-gradient-to-b after:content-['']">
            scroll down to see our craft in motion
          </span>
        </div>
        {images.map((img, idx) => (
